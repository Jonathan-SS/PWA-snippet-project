...
export default function Seed() {
    return (
        <>
            <div className=" h-64 min-w-200-px bg-blue-700 dark:bg-gray-700 top-1/2 left-1/4 rounded-lg p-9 justify-center">
                <h2 className="text-2xl text-white ">
                    It seems that your database is empty, would you like me to
                    seed some data for you?
                </h2>
